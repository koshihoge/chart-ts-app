...
const Home = (props: Props): JSX.Element => {
  const [axisX] = useRecoilState(axisXAtom)
  const [axisY] = useRecoilState(axisYAtom)
  const [mfr] = useRecoilState(classificationMfrAtom)
  const [type] = useRecoilState(classificationTypeAtom)
